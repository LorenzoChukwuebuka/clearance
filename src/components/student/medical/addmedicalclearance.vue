      ...
      <form enctype="multipart/form-data">
        ...
        <div class="input-group input-group-sm mb-3">
          <label class="mb-2 mt-1">
            Upload Medical Receipts
            <br />
            <small> Please choose 2 files at once </small></label
          >
...
export default {
  ...
  methods: {
    ...
    submit(e) {
      ...
      if (self.images.length < 3 || self.images.length > 5) {
        return self.error.push("Select a minimum of 3 files only");
      }
      ...
      self.$http
        ...
        .then((res) => {
          ...
          if (res.data.code == "3") alert(res.data.message);
        })
        .catch((err) => {
          console.log(err);
        });
